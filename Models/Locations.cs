...
namespace PokedexApi.Models
{
    ...
    public class Location : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of game indices relevent to this location by generation.
        /// </summary>
        ...
        /// </summary>
        public IEnumerable<NamedApiResource<LocationArea>> Areas { get; set; }
    }
    ...
    public class LocationArea : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of methods in which Pokémon may be encountered in this
        /// area and how likely the method will occur depending on the version
        /// of the game.
        /// </summary>
        [JsonProperty("encounter_method_rates")]
        public IEnumerable<EncounterMethodRate> EncounterMethodRates { get; set; }
        ...
        /// <summary>
        /// An enumerable of Pokémon that can be encountered in this area along with
        /// version specific details about the encounter.
        /// </summary>
        [JsonProperty("pokemon_encounters")]
        public IEnumerable<PokemonEncounter> PokemonEncounters { get; set; }
    }
    ...
    public class EncounterMethodRate
    {
        ...
        public IEnumerable<EncounterVersionDetails> VersionDetails { get; set; }
    }
    ...
    public class PokemonEncounter
    {
        ...
        /// <summary>
        /// An enumerable of versions and encounters with Pokémon that might happen
    ...
    public class PalParkArea : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of Pokémon encountered in thi pal park area along with
        /// details.
        /// </summary>
        [JsonProperty("pokemon_encounters")]
        public IEnumerable<PalParkEncounterSpecies> PokemonEncounters { get; set; }
    }
    ...
    public class Region : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of locations that can be found in this region.
        /// </summary>
        public IEnumerable<NamedApiResource<Location>> Locations { get; set; }
        ...
        /// <summary>
        /// An enumerable of pokédexes that catalogue Pokémon in this region.
        /// </summary>
        public IEnumerable<NamedApiResource<Pokedex>> Pokedexes { get; set; }

        /// <summary>
        /// An enumerable of version groups where this region can be visited.
        /// </summary>
