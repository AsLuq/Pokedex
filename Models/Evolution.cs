...
namespace PokedexApi.Models
{
    ...
    public class ChainLink
    {
        ...
        public IEnumerable<EvolutionDetail> EvolutionDetails { get; set; }

        /// <summary>
        /// An enumerable of chain objects.
        /// </summary>
        [JsonProperty("evolves_to")]
        public IEnumerable<ChainLink> EvolvesTo { get; set; }
    }
    ...
    public class EvolutionTrigger : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of pokemon species that result from this evolution
        /// trigger.
        /// </summary>
