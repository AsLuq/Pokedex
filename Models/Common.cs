...
namespace PokedexApi.Models
{
    ...
    public class Encounter
    {
        ...
        /// <summary>
        /// An enumerable of condition values that must be in effect for this
        /// encounter to occur.
        /// </summary>
        [JsonProperty("condition_values")]
        public IEnumerable<NamedApiResource<EncounterConditionValue>> ConditionValues { get; set; }
    ...
    public class VersionEncounterDetail
    {
        ...
        /// <summary>
        /// An enumerable of encounters and their specifics.
        /// </summary>
        [JsonProperty("encounter_details")]
        public IEnumerable<Encounter> EncounterDetails { get; set; }
    }
