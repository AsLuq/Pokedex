...
namespace PokedexApi.Models
{
    ...
    public class Item : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of attributes this item has.
        /// </summary>
        public IEnumerable<NamedApiResource<ItemAttribute>> Attributes { get; set; }
        ...
        public IEnumerable<VersionGroupFlavorText> FlavorGroupTextEntries { get; set; }
        ...
        /// <summary>
        /// An enumerable of Pokémon that might be found in the wild holding this item.
        /// </summary>
        [JsonProperty("held_by_pokemon")]
        public IEnumerable<ItemHolderPokemon> HeldByPokemon { get; set; }
        ...
        /// <summary>
        /// An enumerable of the machines related to this item.
        /// </summary>
    ...
    public class ItemHolderPokemon
    {
        ...
        public IEnumerable<ItemHolderPokemonVersionDetail> VersionDetails { get; set; }
    }
    ...
    public class ItemAttribute : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of items that have this attribute.
        /// </summary>
        public IEnumerable<NamedApiResource<Item>> Items { get; set; }
    ...
    public class ItemCategory : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of items that are a part of this category.
        /// </summary>
        public IEnumerable<NamedApiResource<Item>> Items { get; set; }
    ...
    public class ItemFlingEffect : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of items that have this fling effect.
        /// </summary>
        public IEnumerable<NamedApiResource<Item>> Items { get; set; }
    }
    ...
    public class ItemPocket : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of item categories that are relevant to this item pocket.
        /// </summary>
        public IEnumerable<NamedApiResource<ItemCategory>> Categories { get; set; }
