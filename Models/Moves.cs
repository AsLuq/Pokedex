...
namespace PokedexApi.Models
{
    ...
    public class Move : NamedApiResource
    {
        ...
        public IEnumerable<MoveFlavorText> FlavorTextEntries { get; set; }
        ...
        /// <summary>
        /// An enumerable of the machines that teach this move.
        /// </summary>
        public IEnumerable<MachineVersionDetail> Machines { get; set; }
        ...
        /// <summary>
        /// An enumerable of move resource value changes across version groups
        /// of the game.
        /// </summary>
        [JsonProperty("past_values")]
        public IEnumerable<PastMoveStatValues> PastValues { get; set; }

        /// <summary>
        /// An enumerable of stats this moves effects and how much it
        /// effects them.
        /// </summary>
        [JsonProperty("stat_changes")]
        public IEnumerable<MoveStatChange> StatChanges { get; set; }
    ...
    {
        /// <summary>
        /// An enumerable of moves to use before this move.
        /// </summary>
        [JsonProperty("use_before")]
        public IEnumerable<NamedApiResource<Move>> UseBefore { get; set; }

        /// <summary>
        /// An enumerable of moves to use after this move.
        /// </summary>
        [JsonProperty("use_after")]
        public IEnumerable<NamedApiResource<Move>> UseAfter { get; set; }
    }
    ...
    public class MoveAilment : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of moves that cause this ailment.
        /// </summary>
    ...
    public class MoveCategory : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of moves that fall into this category.
        /// </summary>
        public IEnumerable<NamedApiResource<Move>> Moves { get; set; }
    ...
    public class MoveDamageClass : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of moves that fall into this damage public class.
        /// </summary>
        public IEnumerable<NamedApiResource<Move>> Moves { get; set; }
    ...
    public class MoveLearnMethod : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of version groups where moves can be learned through this method.
        /// </summary>
    ...
    public class MoveTarget : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of moves that that are directed at this target.
        /// </summary>
        public IEnumerable<NamedApiResource<Move>> Moves { get; set; }
