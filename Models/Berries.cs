...
namespace PokedexApi.Models
{
    ...
    public class Berry : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of references to each flavor a berry can have
    ...
    public class BerryFirmness : NamedApiResource
    {
        ...
        /// <summary>
        /// An enumerable of berries with this firmness.
        /// </summary>
        public IEnumerable<NamedApiResource<Berry>> Berries { get; set; }
